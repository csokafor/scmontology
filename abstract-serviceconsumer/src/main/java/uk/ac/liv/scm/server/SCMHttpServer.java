...
import uk.ac.liv.scm.serviceconsumer.AbstractServiceConsumer;
...
public class SCMHttpServer {
    ...
    public static void startServer() {
        ...
        rc.registerClasses(AbstractServiceConsumer.class, SecurityFilter.class, AuthenticationExceptionMapper.class);

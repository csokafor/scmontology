...
public class SecurityFilter implements ContainerRequestFilter {
	...
	private static String username = ServiceProperties.getProperty(Constants.USERNAME);
	private static String password = ServiceProperties.getProperty(Constants.PASSWORD);

...
public class SVNServiceProperties {
	
	private static final Logger logger = Logger.getLogger(SVNServiceProperties.class);
	...
	private static void loadPropertiesFile() {
		...
		try {
			...
			File file = new File(env_name + File.separator + "conf" 
					+ File.separator + "svnserviceprovider.properties");

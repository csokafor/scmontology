...
public class SecurityFilter implements ContainerRequestFilter {
	...
	private static String username = TracServiceProperties.getProperty(Constants.USERNAME);
	private static String password = TracServiceProperties.getProperty(Constants.PASSWORD);
